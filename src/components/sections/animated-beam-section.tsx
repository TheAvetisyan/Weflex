...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn(
        "relative flex h-[300px] w-full items-center justify-center overflow-hidden sm:px-10 ",
        className,
      )}
      ref={containerRef}
    >
      <div className="flex w-full max-h-[400px] max-w-lg flex-row items-stretch justify-between gap-10">
        ...
        <div className="flex flex-col justify-center">
          <Circle ref={div6Ref} className="size-11">
            <Image alt="icon" src="/integrationIcons/weflex.png" width={60} height={60} />
          </Circle>
        </div>
        <div className="flex flex-col justify-center gap-2">
          <Circle ref={div1Ref}>
            <Image alt="icon" src="/integrationIcons/github.png" width={30} height={30} />
          </Circle>
          <Circle ref={div2Ref}>
            <Image alt="icon" src="/integrationIcons/docker.png" width={30} height={30} />
          </Circle>
          <Circle ref={div3Ref}>
            <Image alt="icon" src="/integrationIcons/firebase.png" width={30} height={30} />
          </Circle>
          <Circle ref={div4Ref}>
            <Image alt="icon" src="/integrationIcons/postman.png" width={30} height={30} />
          </Circle>
          <Circle ref={div5Ref}>
            <Image alt="icon" src="/integrationIcons/google.png" width={30} height={30} />
          </Circle>
        </div>
      </div>
