...
export function ReasoningBasic() {
  const reasoningText = `Based on your workflow and existing tools, I recommend building a web-based onboarding system with automated form validation, CRM integration, and progress tracking.`;
    ...
    >
      ...
      >
        <div className="flex items-end justify-end gap-3">
          <motion.div
            className="max-w-[280px] bg-blue-200 text-white p-4 rounded-2xl ml-auto shadow-[0_0_10px_rgba(0,0,0,0.05)]"
          ...
          >
            <p className="text-sm">
              We need a custom tool to streamline client onboarding. Can you
              help us design something efficient?
            </p>
          </motion.div>
